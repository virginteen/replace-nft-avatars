...
const run = () => {
	let largeAvatars = document.querySelectorAll('[aria-label="NFT profile picture and Opens NFT details"]')
	let smallAvatars = document.querySelectorAll('[aria-label="NFT profile picture"]')
